...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.usage": "用量",
    "usage.title": "用量统计",
    "usage.records": "{count} 条记录 · 更新于 {time}",
    "usage.refresh": "刷新",
    ...
    "usage.range.1y": "1年",
    "usage.range.all": "全部",
    "usage.scope.global": "全局",
    "usage.scope.project": "本项目",
    "usage.scope.projectHint": "请先选择项目目录",
    "usage.models.all": "全部模型",
    "usage.models.selected": "{count} 个模型",
    "usage.models.selectedOne": "1 个模型",
    "usage.models.clear": "清除筛选",
    "usage.models.title": "按模型筛选",
    "usage.kpi.totalCost": "总成本",
    "usage.kpi.totalTokens": "总 Tokens",
    "usage.kpi.requests": "请求数",
    "usage.kpi.cacheHitRate": "缓存命中率",
    "usage.kpi.input": "输入",
    "usage.kpi.output": "输出",
    "usage.cost.recorded": "实测",
    "usage.cost.estimated": "估算",
    "usage.cost.mixed": "混合",
    "usage.cost.unavailable": "无价格",
    "usage.trend.title": "使用趋势",
    "usage.heatmap.title": "每日用量",
    "usage.heatmap.less": "少",
    "usage.heatmap.more": "多",
    "usage.chart.tokens": "Tokens",
    "usage.chart.cost": "成本",
    "usage.series.total": "总量",
    "usage.series.input": "输入",
    "usage.series.output": "输出",
    "usage.series.cacheRead": "缓存读",
    "usage.series.cacheWrite": "缓存写",
    "usage.series.cost": "成本",
    "usage.byModel.title": "按模型统计",
    "usage.byModel.model": "模型",
    "usage.byModel.requests": "请求",
    "usage.byModel.tokens": "Tokens",
    "usage.byModel.cost": "费用",
    "usage.byModel.avgCost": "均价",
    "usage.donut.title": "模型占比",
    "usage.donut.other": "其他",
    "usage.empty.noPlugin.title": "暂无用量数据",
    "usage.empty.noPlugin.body": "安装 pi-token-usage-statistics 插件并与 Pi 对话后，这里会展示统计：",
    "usage.empty.noData.title": "该时间范围内没有用量",
    "usage.empty.noData.body": "试试更大的时间范围查看历史记录。",
    "usage.empty.noData.action": "查看全部",
    "usage.error.title": "加载用量失败",
    "usage.error.retry": "重试",
    "usage.footer.source": "数据源：{path}",
    "common.git": "Git",
    "git.tab.changes": "变更",
    "git.tab.history": "历史",
    "git.tab.branches": "分支",
    ...
    "git.discard": "丢弃更改",
    "git.deleteFile": "删除文件",
    "git.confirmDiscard": "丢弃 {path} 的所有更改？此操作不可撤销。",
    "git.confirmDeleteFile": "删除未跟踪文件 {path}？此操作不可撤销。",
    "git.commitPlaceholder": "提交信息…",
    "git.commit": "提交",
    "git.committed": "已提交",
    "git.amend": "追加",
    "git.aiMessage": "AI 生成",
    "git.aiModel": "AI 提交信息模型",
    "git.aiModelDefault": "默认（当前会话的模型）",
    "git.commitAll": "提交全部",
    "git.cleanTree": "工作区无更改",
    "git.noChangesSelected": "选择文件查看差异",
    "git.noProject": "请先选择项目目录",
    "git.notARepo": "不是 git 仓库",
    "git.noCommits": "没有提交",
    "git.noFiles": "没有文件更改",
    "git.noDiff": "无差异内容",
    "git.selectCommit": "选择提交查看详情",
    "git.loadMore": "加载更多",
    ...
    "git.remoteName": "名称",
    "git.remoteAdded": "远程已添加",
    "git.remoteRemoved": "远程已移除",
    "git.remoteUpdated": "远程已更新",
    "git.noRemotes": "未配置远程",
    "git.add": "添加",
    "git.edit": "编辑",
    "git.tagMessage": "标签说明（附注标签）",
    ...
    "git.stashSave": "贮藏",
    "git.stashed": "已贮藏更改",
    "git.stashPopped": "贮藏已恢复",
    "git.stashDropped": "贮藏已丢弃",
    "git.noStashes": "没有贮藏",
    "git.pop": "恢复",
    "git.drop": "丢弃",
  },

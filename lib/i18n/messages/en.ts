...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "usage.records": "{count} records · updated {time}",
    ...
    "usage.range.1y": "1Y",
    "usage.range.all": "All",
    "usage.scope.global": "Global",
    "usage.scope.project": "This Project",
    "usage.scope.projectHint": "Select a project first",
    "usage.models.all": "All Models",
    "usage.models.selected": "{count} models",
    "usage.models.selectedOne": "1 model",
    "usage.models.clear": "Clear filter",
    "usage.models.title": "Filter by model",
    "usage.kpi.totalCost": "Total Cost",
    "usage.kpi.totalTokens": "Total Tokens",
    "usage.kpi.requests": "Requests",
    "usage.kpi.cacheHitRate": "Cache Hit Rate",
    "usage.kpi.input": "Input",
    "usage.kpi.output": "Output",
    "usage.cost.recorded": "recorded",
    "usage.cost.estimated": "estimated",
    "usage.cost.mixed": "mixed",
    "usage.cost.unavailable": "no price",
    "usage.trend.title": "Usage Trend",
    "usage.heatmap.title": "Daily Tokens",
    "usage.heatmap.less": "Less",
    "usage.heatmap.more": "More",
    "usage.chart.tokens": "Tokens",
    "usage.chart.cost": "Cost",
    "usage.series.total": "Total",
    "usage.series.input": "Input",
    "usage.series.output": "Output",
    "usage.series.cacheRead": "Cache Read",
    "usage.series.cacheWrite": "Cache Write",
    "usage.series.cost": "Cost",
    "usage.byModel.title": "By Model",
    "usage.byModel.model": "Model",
    "usage.byModel.requests": "Requests",
    "usage.byModel.tokens": "Tokens",
    "usage.byModel.cost": "Cost",
    "usage.byModel.avgCost": "Avg/req",
    "usage.donut.title": "Model Share",
    "usage.donut.other": "Other",
    "usage.empty.noPlugin.title": "No usage data yet",
    "usage.empty.noPlugin.body": "Install the pi-token-usage-statistics plugin and chat with Pi — this dashboard reads the records it keeps:",
    "usage.empty.noData.title": "No usage in this range",
    "usage.empty.noData.body": "Try a wider time range to see your history.",
    "usage.empty.noData.action": "Show all time",
    "usage.error.title": "Failed to load usage",
    "usage.error.retry": "Retry",
    "usage.footer.source": "Data source: {path}",
    "common.git": "Git",
    ...
    "git.confirmDiscard": "Discard all changes in {path}? This cannot be undone.",
    "git.confirmDeleteFile": "Delete untracked file {path}? This cannot be undone.",
    "git.commitPlaceholder": "Commit message…",
    "git.commit": "Commit",
    "git.committed": "Committed",
    "git.amend": "Amend",
    "git.aiMessage": "AI message",
    "git.aiModel": "AI commit-message model",
    "git.aiModelDefault": "Default (current session's model)",
    "git.commitAll": "Commit All",
    "git.cleanTree": "Working tree clean",
    "git.noChangesSelected": "Select a file to view its diff",
    "git.noProject": "Select a project directory first",
    ...
    "git.remoteUpdated": "Remote updated",
    "git.noRemotes": "No remotes configured",
    "git.add": "Add",
    "git.edit": "Edit",
    "git.tagMessage": "Tag message (annotated)",
    "git.tagCreated": "Tag created",
    "git.tagDeleted": "Tag deleted",
    "git.noTags": "No tags",
    "git.annotated": "annotated",
